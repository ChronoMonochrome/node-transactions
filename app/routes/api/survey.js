module.exports = function(app) {
    ...
    app.get("/api/parameterTypes/:id", function(req, res, next) {
        ...
        req.models.parameterType.one({
            id: req.params.id
        }, function(err, parameterType) {
            if (err) return next(err);
    ...
    app.put("/api/parameterTypes/:id", function(req, res, next) {
        ...
        req.models.parameterType.find({
            id: req.params.id
        }).each(function(parameterType) {
    ...
    app.get("/api/parameterForms/:id", function(req, res, next) {
        ...
        req.models.parameterForm.one({
            id: req.params.id
        }, function(err, parameterForm) {
            if (err) return next(err);
    ...
    app.put("/api/parameterForms/:id", function(req, res, next) {
        ...
        req.models.parameterForm.find({
            id: req.params.id
        }).each(function(parameterForm) {
    ...
    app.get("/api/parameterGroups/:id", function(req, res, next) {
        ...
        req.models.parameterGroup.one({
            id: req.params.id
        }, function(err, parameterGroup) {
            if (err) return next(err);
    ...
    app.put("/api/parameterGroups/:id", function(req, res, next) {
        ...
        req.models.parameterGroup.find({
            id: req.params.id
        }).each(function(parameterGroup) {
